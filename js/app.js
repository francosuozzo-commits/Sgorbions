...
function renderWantlist() {
  ...
  if (!missing.length) {
    ...
    el.innerHTML = '<div class="empty-state"><div class="empty-icon">🎉</div><p class="empty-title">' + (currentLang === 'it' ? 'Complimenti! Hai tutto!' : 'Congrats! You have it all!') + '</p><p class="empty-sub">' + (currentLang === 'it' ? 'Non ti manca nessuna figurina.' : 'You are not missing any sticker.') + '</p></div>' + (completeBoxes ? '<hr style="border-color:var(--border);margin:1rem 0;"><h3 style="font-family:var(--font-ui);font-size:1.2rem;margin-bottom:0.4rem;">' + (currentLang === 'it' ? 'EXPORT DELLE TUE SERIE COMPLETE' : 'EXPORT OF YOUR COMPLETE SERIES') + '</h3><p style="font-size:0.85rem;color:var(--muted);margin-bottom:0.5rem;">' + (currentLang === 'it' ? 'Seleziona le serie per le quali vuoi esportare l\'elenco delle figurine che hai e poi premi il tasto "Esporta lista figurine che ho", qui affianco.' : 'Select the series for which you want to export your owned stickers, then press "Export owned stickers list" next to this.') + '</p><div style="margin-bottom:1rem;"><button class="btn-secondary" onclick="exportOwnedList()" style="font-size:0.88rem;">' + (currentLang === 'it' ? 'Esporta lista figurine che ho' : 'Export owned stickers list') + '</button></div>' + completeBoxes : '');
    return;
  }
  ...
  if (completeSeries.length) {
    ...
    el.innerHTML += '<hr style="border-color:var(--border);margin:1rem 0;"><h3 style="font-family:var(--font-ui);font-size:1.2rem;margin-bottom:0.4rem;">' + (currentLang === 'it' ? 'EXPORT DELLE TUE SERIE COMPLETE' : 'EXPORT OF YOUR COMPLETE SERIES') + '</h3><p style="font-size:0.85rem;color:var(--muted);margin-bottom:0.5rem;">' + (currentLang === 'it' ? 'Seleziona le serie per le quali vuoi esportare l\'elenco delle figurine che hai e poi premi il tasto "Esporta lista figurine che ho", qui affianco.' : 'Select the series for which you want to export your owned stickers, then press "Export owned stickers list" next to this.') + '</p><div style="margin-bottom:1rem;"><button class="btn-secondary" onclick="exportOwnedList()" style="font-size:0.88rem;">' + (currentLang === 'it' ? 'Esporta lista figurine che ho' : 'Export owned stickers list') + '</button></div>' + completeBoxes;
  }
}
...
async function exportOwnedIncomplete() {
  ...
  if (rows.length <= 1) { toast(currentLang === 'it' ? 'Nessuna fig da esportare' : 'No stickers to export', 'error'); return; }
